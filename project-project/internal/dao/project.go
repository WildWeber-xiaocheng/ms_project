...
func (p ProjectDao) FindProjectMemberByPid(ctx context.Context, projectCode int64, page int64, pageSize int64) (list []*data.ProjectMember, total int64, err error) {
	session := p.conn.Session(ctx)
...
func (p ProjectDao) FindProjectByPIdAndMemId(ctx context.Context, projectCode int64, memId int64) (*data.ProjectAndMember, error) {
